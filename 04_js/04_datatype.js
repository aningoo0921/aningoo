...
console.log(letters2[3][0] + letters2[1][3] + letters2[0][1] + lletters2[0][3] + letters2[2][2]);
...
console.log(str2.toString()); // true
...
console.log(parseInt(n4))//소수점 벌임
...
let engScore2 = Number(prompt('영어 점수를 입력해주세요.'))

let avgScore2 = (mathScore2 + engScore2) /2;
console.log(avgScore2);

// let mathScore2 = prompt('수학 점수를 입력하세요.');
// let engScore2 = prompt('영어 점수를 입력해주세요.');
